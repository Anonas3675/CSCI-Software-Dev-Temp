...
-- Updated INSERT statement to include every correct answer to a wordle in the past, and deleted all duplicates
INSERT INTO Wordle_Word_Bank (word) VALUES 
('duane'), ('grown'), ('birch'), ('runny'), ('toner'), ('gunky'), ('buffs'), ('arise'), ('hiker'), ('bikes'), 
('flats'), ('dorms'), ('stems'), ('trees'), ('alums'), ('leeds'), ('blast'), ('blaze'), ('notes'), ('shred'), ('scoot')
('aback'), ('abhor'), ('abide'), ('abort'), ('above'), ('abuse'), ('acorn'), ('actor'), ('acute'), ('adapt'),
('adept'), ('admin'), ('admit'), ('adobe'), ('adopt'), ('adore'), ('adorn'), ('affix'), ('afire'), ('afoot'),
('afoul'), ('after'), ('again'), ('agape'), ('agate'), ('agent'), ('agile'), ('aging'), ('aglow'), ('agree'),
('ahead'), ('aider'), ('aisle'), ('alarm'), ('album'), ('alert'), ('algae'), ('alibi'), ('alien'), ('align'),
('alike'), ('alive'), ('allay'), ('alley'), ('allot'), ('allow'), ('aloft'), ('alone'), ('along'), ('aloof'),
('aloud'), ('alpha'), ('altar'), ('alter'), ('amass'), ('amaze'), ('amber'), ('amble'), ('amend'), ('amiss'),
('amity'), ('among'), ('ample'), ('amply'), ('amuse'), ('angel'), ('anger'), ('angle'), ('angry'), ('anime'),
('ankle'), ('annex'), ('annoy'), ('antic'), ('anvil'), ('apart'), ('aphid'), ('aping'), ('apple'), ('apply'),
('apron'), ('aptly'), ('arbor'), ('ardor'), ('arena'), ('argue'), ('armor'), ('aroma'), ('arose'), ('array'),
('arrow'), ('arson'), ('artsy'), ('ashen'), ('aside'), ('askew'), ('asset'), ('atoll'), ('atone'), ('attic'),
('audio'), ('audit'), ('augur'), ('aunty'), ('avail'), ('avert'), ('avian'), ('avoid'), ('await'), ('awake'),
('award'), ('aware'), ('awash'), ('awful'), ('awoke'), ('axial'), ('axiom'), ('azure'), ('badge'), ('badly'),
...
('bigot'), ('bilge'), ('billy'), ('binge'), ('bingo'), ('biome'), ('birth'), ('bison'), ('bitty'), ('black'),
('blade'), ('blame'), ('bland'), ('blank'), ('blare'), ('bleak'), ('bleat'), ('bleed'), ('bleep'), ('blend'),
...
('green'), ('greet'), ('grief'), ('grill'), ('grimy'), ('grind'), ('groom'), ('grove'), ('growl'), ('grump'), 
